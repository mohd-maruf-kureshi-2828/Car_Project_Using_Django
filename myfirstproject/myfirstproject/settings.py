...
SECRET_KEY = 'django-insecure-7@un87)q0jf$arnp=o&dkb0*ddr=xagccthv1mdoe7-n#m3^+#'
...
INSTALLED_APPS = [
    ...
    'myapp',
    # Remove tailwind and browser reload in production
]
...
# ✅ Static and Media for Render Deployment
STATIC_URL = '/static/'
